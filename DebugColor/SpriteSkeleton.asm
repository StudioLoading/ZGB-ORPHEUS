...
;--------------------------------------------------------
	...
	C$SpriteSkeleton.c$29$0_0$186	= .
	.globl	C$SpriteSkeleton.c$29$0_0$186
;SpriteSkeleton.c:29: void START(){
;	---------------------------------
; Function Start_SpriteSkeleton
; ---------------------------------
_Start_SpriteSkeleton::
	C$SpriteSkeleton.c$30$1_0$186	= .
	.globl	C$SpriteSkeleton.c$30$1_0$186
;SpriteSkeleton.c:30: SetSpriteAnim(THIS, a_skeleton_hidden, 6);
	...
	ld	d, (hl)
	call	_SetSpriteAnim
	C$SpriteSkeleton.c$31$1_1$187	= .
	.globl	C$SpriteSkeleton.c$31$1_1$187
;SpriteSkeleton.c:31: struct EnemyInfo* e_data = (struct EnemyInfo*) THIS->custom_data;
	...
	inc	b
00122$:
	C$SpriteSkeleton.c$32$1_1$187	= .
	.globl	C$SpriteSkeleton.c$32$1_1$187
;SpriteSkeleton.c:32: e_data->frmskip = 16u;
	ld	hl, #0x0007
	add	hl, bc
	ld	(hl), #0x10
	C$SpriteSkeleton.c$33$1_1$187	= .
	.globl	C$SpriteSkeleton.c$33$1_1$187
...
00124$:
	...
	bit	0, c
	jr	NZ, 00105$
	C$SpriteSkeleton.c$35$2_1$188	= .
	.globl	C$SpriteSkeleton.c$35$2_1$188
...
;SpriteSkeleton.c:31: struct EnemyInfo* e_data = (struct EnemyInfo*) THIS->custom_data;
	...
	ld	e, a
	ld	d, (hl)
	C$SpriteSkeleton.c$36$1_1$186	= .
	.globl	C$SpriteSkeleton.c$36$1_1$186
...
00102$:
	...
	ld	(hl), e
00105$:
	C$SpriteSkeleton.c$38$1_1$187	= .
	.globl	C$SpriteSkeleton.c$38$1_1$187
;SpriteSkeleton.c:38: e_change_state(THIS, WALK_DOWN, THIS->type);
	...
	call	___sdcc_bcall_ehl
	add	sp, #4
	C$SpriteSkeleton.c$39$1_1$186	= .
	.globl	C$SpriteSkeleton.c$39$1_1$186
;SpriteSkeleton.c:39: }
	C$SpriteSkeleton.c$39$1_1$186	= .
	.globl	C$SpriteSkeleton.c$39$1_1$186
...
_a_skeleton_repelled:
	...
	C$SpriteSkeleton.c$41$1_1$189	= .
	.globl	C$SpriteSkeleton.c$41$1_1$189
;SpriteSkeleton.c:41: void UPDATE(){
;	---------------------------------
; Function Update_SpriteSkeleton
; ---------------------------------
_Update_SpriteSkeleton::
	C$SpriteSkeleton.c$42$1_0$189	= .
	.globl	C$SpriteSkeleton.c$42$1_0$189
;SpriteSkeleton.c:42: struct EnemyInfo* e_data = (struct EnemyInfo*) THIS->custom_data;
	ld	hl, #_THIS
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
	C$SpriteSkeleton.c$43$1_0$189	= .
	.globl	C$SpriteSkeleton.c$43$1_0$189
;SpriteSkeleton.c:43: if(e_data->e_configured == 0){
	ld	hl, #0x21
	add	hl,bc
	ld	a, (hl)
	or	a, a
	C$SpriteSkeleton.c$44$2_0$190	= .
	.globl	C$SpriteSkeleton.c$44$2_0$190
;SpriteSkeleton.c:44: return;
	ret	Z
	C$SpriteSkeleton.c$46$1_0$189	= .
	.globl	C$SpriteSkeleton.c$46$1_0$189
;SpriteSkeleton.c:46: e_management(THIS);
	...
	call	___sdcc_bcall_ehl
	pop	hl
	C$SpriteSkeleton.c$47$1_0$189	= .
	.globl	C$SpriteSkeleton.c$47$1_0$189
;SpriteSkeleton.c:47: }
	C$SpriteSkeleton.c$47$1_0$189	= .
	.globl	C$SpriteSkeleton.c$47$1_0$189
	...
	C$SpriteSkeleton.c$49$1_0$192	= .
	.globl	C$SpriteSkeleton.c$49$1_0$192
...
_skeleton_update_anim::
	C$SpriteSkeleton.c$50$1_0$192	= .
	.globl	C$SpriteSkeleton.c$50$1_0$192
;SpriteSkeleton.c:50: switch(new_state){
	ld	a, #0x0c
	ldhl	sp,	#8
	sub	a, (hl)
	ret	C
	C$SpriteSkeleton.c$58$1_0$192	= .
	.globl	C$SpriteSkeleton.c$58$1_0$192
...
00120$:
	...
	jp	00111$
	jp	00109$
	C$SpriteSkeleton.c$51$2_0$193	= .
	.globl	C$SpriteSkeleton.c$51$2_0$193
;SpriteSkeleton.c:51: case IDLE_UP: case WALK_UP: 
00102$:
	C$SpriteSkeleton.c$52$2_0$193	= .
	.globl	C$SpriteSkeleton.c$52$2_0$193
;SpriteSkeleton.c:52: SetSpriteAnim(s_enemy, a_skeleton_up, 6);
	...
	ld	d, (hl)
	call	_SetSpriteAnim
	C$SpriteSkeleton.c$53$2_0$193	= .
	.globl	C$SpriteSkeleton.c$53$2_0$193
;SpriteSkeleton.c:53: break;
	ret
	C$SpriteSkeleton.c$54$2_0$193	= .
	.globl	C$SpriteSkeleton.c$54$2_0$193
;SpriteSkeleton.c:54: case IDLE_DOWN: case WALK_DOWN:
00104$:
	C$SpriteSkeleton.c$55$2_0$193	= .
	.globl	C$SpriteSkeleton.c$55$2_0$193
;SpriteSkeleton.c:55: SetSpriteAnim(s_enemy, a_skeleton_down, 6);
	...
	ld	d, (hl)
	call	_SetSpriteAnim
	C$SpriteSkeleton.c$56$2_0$193	= .
	.globl	C$SpriteSkeleton.c$56$2_0$193
;SpriteSkeleton.c:56: break;
	ret
	C$SpriteSkeleton.c$57$2_0$193	= .
	.globl	C$SpriteSkeleton.c$57$2_0$193
;SpriteSkeleton.c:57: case IDLE_LEFT: case WALK_LEFT:
00106$:
	C$SpriteSkeleton.c$58$2_0$193	= .
	.globl	C$SpriteSkeleton.c$58$2_0$193
;SpriteSkeleton.c:58: s_enemy->mirror = V_MIRROR;
	ld	a, #0x02
	ld	(bc), a
	C$SpriteSkeleton.c$59$2_0$193	= .
	.globl	C$SpriteSkeleton.c$59$2_0$193
;SpriteSkeleton.c:59: SetSpriteAnim(s_enemy, a_skeleton_h, 8);
	...
	ld	bc, #_a_skeleton_h
	call	_SetSpriteAnim
	C$SpriteSkeleton.c$60$2_0$193	= .
	.globl	C$SpriteSkeleton.c$60$2_0$193
;SpriteSkeleton.c:60: break;
	ret
	C$SpriteSkeleton.c$61$2_0$193	= .
	.globl	C$SpriteSkeleton.c$61$2_0$193
;SpriteSkeleton.c:61: case IDLE_RIGHT: case WALK_RIGHT: 
00108$:
	C$SpriteSkeleton.c$62$2_0$193	= .
	.globl	C$SpriteSkeleton.c$62$2_0$193
;SpriteSkeleton.c:62: s_enemy->mirror = NO_MIRROR;
	xor	a, a
	ld	(bc), a
	C$SpriteSkeleton.c$63$2_0$193	= .
	.globl	C$SpriteSkeleton.c$63$2_0$193
;SpriteSkeleton.c:63: SetSpriteAnim(s_enemy, a_skeleton_h, 8);
	...
	ld	bc, #_a_skeleton_h
	call	_SetSpriteAnim
	C$SpriteSkeleton.c$64$2_0$193	= .
	.globl	C$SpriteSkeleton.c$64$2_0$193
;SpriteSkeleton.c:64: break;
	ret
	C$SpriteSkeleton.c$65$2_0$193	= .
	.globl	C$SpriteSkeleton.c$65$2_0$193
;SpriteSkeleton.c:65: case HIT:
00109$:
	C$SpriteSkeleton.c$66$2_0$193	= .
	.globl	C$SpriteSkeleton.c$66$2_0$193
;SpriteSkeleton.c:66: SetSpriteAnim(s_enemy, a_skeleton_repelled, 12);
	...
	ld	d, (hl)
	call	_SetSpriteAnim
	C$SpriteSkeleton.c$68$1_0$192	= .
	.globl	C$SpriteSkeleton.c$68$1_0$192
;SpriteSkeleton.c:68: }
00111$:
	C$SpriteSkeleton.c$69$1_0$192	= .
	.globl	C$SpriteSkeleton.c$69$1_0$192
;SpriteSkeleton.c:69: }
	C$SpriteSkeleton.c$69$1_0$192	= .
	.globl	C$SpriteSkeleton.c$69$1_0$192
	...
	C$SpriteSkeleton.c$71$1_0$194	= .
	.globl	C$SpriteSkeleton.c$71$1_0$194
;SpriteSkeleton.c:71: void DESTROY(){
;	---------------------------------
; Function Destroy_SpriteSkeleton
; ---------------------------------
_Destroy_SpriteSkeleton::
	C$SpriteSkeleton.c$72$1_0$194	= .
	.globl	C$SpriteSkeleton.c$72$1_0$194
;SpriteSkeleton.c:72: e_destroy(THIS, THIS->type);
	...
	call	___sdcc_bcall_ehl
	add	sp, #3
	C$SpriteSkeleton.c$73$1_0$194	= .
	.globl	C$SpriteSkeleton.c$73$1_0$194
;SpriteSkeleton.c:73: }
	C$SpriteSkeleton.c$73$1_0$194	= .
	.globl	C$SpriteSkeleton.c$73$1_0$194
