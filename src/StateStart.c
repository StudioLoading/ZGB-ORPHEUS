...
MACROMAP solved_map = HADES_THREE; //TODO NONE
MACROMAP current_map = HADES_FOUR; //TODO TUTORIAL
MACROMAP next_map = BOSS_CHARON; //TODO HADES_ZERO
MACROMAP prev_map = HADES_THREE; //TODO NONE
MACROMAP max_map = HADES_THREE; //TODO TUTORIAL
